...
export function FitFamComparison() {
  ...
  }>({ partnerId: undefined, workoutCount: 0, completedCount: 0 });
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        setDebugInfo({
          partnerId,
          workoutCount: partnerStats.workouts?.length || 0,
          completedCount: partnerStats.workouts?.filter(w => w.completed).length || 0
        });
          ...
          <div>
            ...
            <div className="space-y-1">
              <p className="text-gray-400">
                Compare your workout progress and stay motivated together
              </p>
              <div className="text-sm text-gray-500 space-y-1">
                <p>Partner ID: {debugInfo.partnerId}</p>
                <p>Total Workouts: {debugInfo.workoutCount}</p>
                <p>Completed Workouts: {debugInfo.completedCount}</p>
              </div>
            </div>
          </div>
          <button
